...
$sofResourceGroup = Get-AzResourceGroup -Name "${ResourceGroupNm}-sof" -ErrorAction SilentlyContinue
if (!$sofResourceGroup) {
    New-AzResourceGroup -Name "${ResourceGroupNm}-sof" -Location $EnvironmentLocation | Out-Null
}
